...
/**
 * Models Fast Lands such as <a href="http://magiccards.info/query?q=!Seachrome+Coast">Seachrome
 * Coast</a>.
 *
 * <p>Fast Lands enter the battlefield tapped unless unless not more than two other lands are on the
 * board.
 */
