...
public class Parser {
    ...
    public Expression parseSingleExpression(List<StringToken> stringTokens) throws RuleLoader.RulesParseException {
    ...
    private static Expression parseRPNStack(Stack<Token> stack)
        ...
        if (!stack.isEmpty()) {
            throw new RuleLoader.RulesParseException(stack.peek() + " is no operand of any operation",
                    0);
        }
