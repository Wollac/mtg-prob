...
interface Parentheses extends Operator {
  ...
  static String getProductionRules() {
    return NamingConventions.EXPRESSION + NamingConventions.ARROW_OPERATOR + OPEN_PARENTHESIS_CHAR
        + NamingConventions.EXPRESSION + CLOSE_PARENTHESIS_CHAR;
  }
  ...
  enum OpenParenthesis implements Parentheses {
    ...
    @Override public Expression parse(Stack<Token> stack) {
