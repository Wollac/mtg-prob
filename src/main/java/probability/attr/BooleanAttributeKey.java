...
public class BooleanAttributeKey extends AttributeKey<Boolean> {
  ...
  public BooleanAttributeKey(String name, boolean defaultValue, Predicate<Boolean> validator) {
  ...
  @Override public Boolean parseValue(String valueString) throws AttributeParseException {
    ...
    throw new AttributeParseException(AttributeParseException.AttributeParseError.UNPARSABLE_VALUE,
        this);
  }
