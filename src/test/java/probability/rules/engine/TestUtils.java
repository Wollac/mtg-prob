...
class TestUtils {
  ...
  static <T> ImmutableAttributeHolder createSingleVariableBinding(AttributeKey<T> key,
      T varBinding) {
  ...
  static Expression createVariableValueOperatorExpression(Operation operation, AttributeKey<?> key,
      String valueString) throws Token.RulesTokenException {
