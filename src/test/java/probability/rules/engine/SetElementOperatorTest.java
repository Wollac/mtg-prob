...
@RunWith(Parameterized.class) public class SetElementOperatorTest {
  ...
  public static Collection<Object[]> data() {
    return Arrays.asList(
        new Object[][] {{Sets.newHashSet("A", ""), ""}, {Sets.newHashSet("A", "B"), "A"},
            {Sets.newHashSet("A", "B"), "[A, B]"}, {Collections.emptySet(), ""},
            {Collections.emptySet(), "[]"}, {Sets.newHashSet("A"), "B"}});
  }
  ...
  private static void testOperation(Set<String> varBinding, String value, Operation operation,
      BiPredicate<Set<String>, String> expected) {
  ...
  private static void assertValidException(String value,
      Token.RulesTokenException caughtException) {
